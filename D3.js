...
for (let i = 0; i < femaleCharacters.length; i++) {
  charactersNames = charactersNames.filter((name) => name !== femaleCharacters[i].name);
}
console.log(charactersNames);
...
console.log(
  `Ciao sono ${starWarsCharacters[num].name} e sono alto ${starWarsCharacters[num].height} metri, peso ${starWarsCharacters[num].mass} Kg, ho i capelli ${starWarsCharacters[num].hair_color}`
);
